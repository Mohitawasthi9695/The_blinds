    ...
    public function store(StockOutRequest $request)
    {
        ...
        try {
            ...
            foreach ($validatedData['out_products'] as $product) {
                ...
                $restLength = $availableStock->available_height - $outLength;
            ...
            return response()->json(['error' => 'An error occurred while creating the StockOutInvoice.'], 500);
        }
    }
